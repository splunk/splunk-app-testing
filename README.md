...
The CI/CD pipeline relies on a few images which are stored in the splunk organization.
When forking this repo, make sure you add these images to a repository you can fully access.
